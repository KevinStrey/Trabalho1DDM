...
import br.com.udesc.prototipotrabalho1.domain.usecase.GetDormitoryByFamilyIdUseCase
...
class FamilyMembersViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(FamilyMembersViewModel::class.java)) {
            ...
            return FamilyMembersViewModel(familyId, getFamilyByIdUseCase, getMembersByFamilyIdUseCase, getInteractionsByFamilyIdUseCase, getDormitoryByFamilyIdUseCase) as T
        }
